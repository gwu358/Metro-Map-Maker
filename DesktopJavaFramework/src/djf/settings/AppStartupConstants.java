...
public class AppStartupConstants
{
    ...
    public static final String APP_PROPERTIES_FILE_NAME_CH = "app_properties_CH.xml";
    ...
    public static String PROPERTIES_FILE_ERROR_MESSAGE_CH = "Error Loading " + APP_PROPERTIES_FILE_NAME_CH;
